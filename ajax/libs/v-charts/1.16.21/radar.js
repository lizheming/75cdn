(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('echarts/lib/echarts'), require('echarts/lib/component/tooltip'), require('echarts/lib/component/legend'), require('numerify/lib/index.es'), require('echarts/lib/chart/radar')) :
  typeof define === 'function' && define.amd ? define(['echarts/lib/echarts', 'echarts/lib/component/tooltip', 'echarts/lib/component/legend', 'numerify/lib/index.es', 'echarts/lib/chart/radar'], factory) :
  (global.VeRadar = factory(global.echarts,null,null,global.numerify));
