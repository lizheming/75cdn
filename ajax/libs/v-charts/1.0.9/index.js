(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('echarts/lib/echarts'), require('echarts/lib/component/tooltip'), require('echarts/lib/component/legend'), require('echarts/lib/component/title'), require('echarts/lib/chart/bar'), require('echarts/lib/chart/line'), require('echarts/lib/chart/pie'), require('echarts/lib/chart/funnel'), require('echarts/lib/chart/radar')) :
	typeof define === 'function' && define.amd ? define(['echarts/lib/echarts', 'echarts/lib/component/tooltip', 'echarts/lib/component/legend', 'echarts/lib/component/title', 'echarts/lib/chart/bar', 'echarts/lib/chart/line', 'echarts/lib/chart/pie', 'echarts/lib/chart/funnel', 'echarts/lib/chart/radar'], factory) :
...
var components = [VeBar, VeColumn, VeLine, VePie, VeRing, VeWaterfall, VeFunnel, VeRadar, VeChart];
...
var index = { VeBar: VeBar, VeColumn: VeColumn, VeRing: VeRing, VeLine: VeLine, VePie: VePie, VeWaterfall: VeWaterfall, VeFunnel: VeFunnel, VeRadar: VeRadar, VeChart: VeChart, install: install };
