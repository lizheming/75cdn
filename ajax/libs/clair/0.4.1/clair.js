	...
	*/
	...
	var $2_6 = {
	  ...
	  methods: {
	    syncDate: function syncDate() {
	      ...
	      this.date = this.value || new Date().format(this.format); // this.date = this.value || this.date || new Date().format(this.format)
	    ...
	    selectMonth: function selectMonth(month) {
	      ...
	      if (this.type === 'month') {
	        var date = "".concat(this.year, "-").concat(this.fixZero(this.month + 1));
	        this.date = new Date(date).format(this.format);
	        this.$emit('update', this.date);
	      }
	    },
	    ...
	    updateMonthBykeydown: function updateMonthBykeydown(num, type) {
	      var _this$updateMonth = this.updateMonth(this.year, this.month, num, type),
	          _this$updateMonth2 = _slicedToArray(_this$updateMonth, 2),
	          year = _this$updateMonth2[0],
	          month = _this$updateMonth2[1];
	...
	var $2_7 = {
	  render: function render() {
	    ...
	    }, [_c('tbody', _vm._l(_vm.monthRows, function (monthRow) {
	      return _c('tr', _vm._l(monthRow, function (item) {
	        return _c('td', {
	          on: {
	            "click": function click($event) {
	          ...
	          class: {
	            ...
	            'active': _vm.isSelectedMonth(item) && item === _vm.month
	          }
	...
	var validatable = {
	  ...
	  methods: {
	    validate: function validate() {
	      ...
	      var result = Validator.validate(this.value, rules);
	      ...
	      if (isPromise(result)) {
	        ...
	        (function () {
	          var id = _this.asyncValidationId;
	          result.then(function (v) {
	            if (_this.asyncValidationId === id) setValidity(v);
	          });
	        })();
	      } else {
	        setValidity(result);
	...
	*/
	  ...
	  render: function render() {
	    ...
	    return _c('div', {
	      ...
	      attrs: {
	        ...
	        "monthsShow": _vm.startMonthsShow
	      },
	      on: {
	...
	var $2_16 = {
	  render: function render() {
	    ...
	    }, [_vm.date != '' || _vm.daterange != '' ? _c('div', {
	      staticClass: "c-datepicker__icon c-datepicker__hovericon",
	      class: _vm.className,
	      on: {
	        "click": _vm.resetDate
	      }
	    ...
	    })], 1), _vm.type == 'daterange' || _vm.type == 'monthrange' ? _c('c-input', {
	      attrs: {
	        "placeholder": _vm.placeholder,
	        "disabled": _vm.disabled,
	        "width": "normal",
	    ...
	    }) : _vm.type == 'date' || _vm.type == 'month' ? _c('c-input', {
	      attrs: {
	        "size": _vm.size,
	        "width": "normal",
	        "placeholder": _vm.placeholder,
	    ...
	    }, [_vm.type == 'date' || _vm.type == 'month' ? _c('c-calendar', {
	      ref: "calendar",
	      attrs: {
	        "type": _vm.type,
	        "pattern": _vm.datePattern,
	        "value": _vm.date,
	        "show": _vm.isOpen,
	        "size": _vm.size,
	        "minDate": _vm.minDate,
	    ...
	    })], 1) : _vm._e(), _vm.type == 'monthrange' ? _c('div', {
	      staticClass: "c-datepicker__body"
	    }, [_c('c-daterange', {
	      attrs: {
	        "value": _vm.date,
	  ...
	  computed: {
	    className: function className() {
	      return this.size ? "is-size-".concat(this.size) : '';
	    },
	...
	var $2_18 = {
	  ...
	  methods: {
	    ...
	    isValid: function isValid() {
	      var results = this.validatables.map(function (v) {
	        return v.validate();
	      });
	      var hasAsync = results.some(isPromise);

	      var isAllValid = function isAllValid(results) {
	...
	var $2_32 = {
	  render: function render() {
	    ...
	    return _c('div', {
	      ...
	      return _vm.multiple && index <= _vm.maxChipCount ? _c('div', {
	        key: index,
	        staticClass: "c-chip",
	        class: {
	          'is-disabled': option.disabled,
	          'is-closeable': index < _vm.maxChipCount
	        }
	      }, [_vm._t("selection", [index < _vm.maxChipCount ? _c('span', [_vm._v(_vm._s(option.label))]) : _c('span', [_vm._v(_vm._s(_vm.maxChipText))])], {
	        option: option
	      }), index < _vm.maxChipCount ? _c('div', {
	  ...
	  props: {
	    ...
	    maxChipPlaceholder: {
	      ...
	      default: function _default(ommittedCount) {
	        return "\u548C\u5176\u5B83".concat(ommittedCount, "\u4E2A\u9009\u9879");
	      }
	    }
	  },
	  model: {
	  ...
	  computed: {
	    ...
	    maxChipText: function maxChipText() {
	      ...
	      var maxChipPlaceholder = this.maxChipPlaceholder;
	  ...
	  created: function created() {
	    ...
	    this.filterFunction = throttle_1(function (options, query) {
	      var filtered = _this.filter(options, query);

	      if (typeof filtered.then === 'function') {
	        var promiseId = Date.now();
	        _this.promiseId = promiseId;
	        filtered.then(function (options) {
	          if (_this.promiseId > promiseId) return;
	          _this.filteredOptions = normalizeOptions(options);
	        });
	      } else {
	        _this.filteredOptions = normalizeOptions(filtered);
	      }
	    }, this.filterThrottle, {
	      leading: true,
	      trailing: true
	      ...
	      return new Promise(function ($return, $error) {
	        ...
	        var options = {
	          ...
	          onSuccess: function onSuccess(res) {
	            ...
	            uploadFileCount--;
	            if (uploadFileCount === 0) _this2.loading = false;
	          },
