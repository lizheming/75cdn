...
var Mod31 = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[(_vm.height)?[_c('table',[_c('thead',_vm._l((_vm.columnsRows),function(column){return _c('tr',_vm._l((column.columns),function(item){return _c('th',{class:_vm.getColumnClassName(item),style:(_vm.getCellStyle(item)),attrs:{"colspan":item.colspan,"rowspan":item.rowspan}},[_vm._t(item.key + '-base-th',[_c('span',[_vm._v(_vm._s(item.title))]),(item.type === 'selection')?_c('span',{staticClass:"c-table__check"},[_c('c-checkbox',{attrs:{"indeterminate":_vm.indeterminate},on:{"change":_vm.onSelectAllChange},model:{value:(_vm.allChecked),callback:function ($$v) {_vm.allChecked=$$v;},expression:"allChecked"}})],1):(item.sorter)?_c('span',{staticClass:"c-table__sort"},[_c('div',{staticClass:"c-sort-asc",class:{'sorted': _vm.checkSorted(item.key, 'asc')},on:{"click":function($event){_vm.onSorted(item.key, 'asc');}}},[_c('i',{staticClass:"sort-asc"})]),_c('div',{staticClass:"c-sort-desc",class:{'sorted': _vm.checkSorted(item.key, 'desc')},on:{"click":function($event){_vm.onSorted(item.key, 'desc');}}},[_c('i',{staticClass:"sort-desc"})])]):_vm._e()])],2)}))}))]),_c('div',{staticClass:"c-table__body",style:(_vm.getTbodyStyle)},[_c('table',[_c('tbody',[(_vm.dataList.length == 0)?_c('tr',{staticClass:"c-table__noresult"},[_c('td',{attrs:{"colspan":_vm.columns.length}},[_vm._v("暂无数据")])]):_vm._l((_vm.dataList),function(dataItem,index){return _c('tr',{class:_vm.getRowClassName(_vm.item, index),on:{"mouseenter":function($event){_vm.setCurrentItem(dataItem);},"mouseleave":_vm.resetCurrentItem}},_vm._l((_vm.allColumns),function(columnsItem){return _c('td',{class:_vm.getColumnClassName(columnsItem),style:(_vm.getCellStyle(columnsItem))},[_vm._t(columnsItem.key + '-base-td',[(columnsItem.type === 'selection')?_c('span',{staticClass:"c-table__check"},[_c('c-checkbox',{on:{"change":_vm.onSelectChange},model:{value:(dataItem._checked),callback:function ($$v) {_vm.$set(dataItem, "_checked", $$v);},expression:"dataItem._checked"}})],1):_vm._e(),(columnsItem.render)?_c('div',{domProps:{"innerHTML":_vm._s(columnsItem.render(index, dataItem[columnsItem.key], dataItem))}}):_c('span',[_vm._v(_vm._s(dataItem[columnsItem.key]))])],{item:dataItem})],2)}))})],2)])])]:[_c('table',[_c('thead',_vm._l((_vm.columnsRows),function(column){return _c('tr',_vm._l((column.columns),function(item){return _c('th',{class:_vm.getColumnClassName(item),style:(_vm.getCellStyle(item)),attrs:{"colspan":item.colspan,"rowspan":item.rowspan}},[_vm._t(item.key + '-base-th',[_c('span',[_vm._v(_vm._s(item.title))]),(item.type === 'selection')?_c('span',{staticClass:"c-table__check"},[_c('c-checkbox',{attrs:{"indeterminate":_vm.indeterminate},on:{"change":_vm.onSelectAllChange},model:{value:(_vm.allChecked),callback:function ($$v) {_vm.allChecked=$$v;},expression:"allChecked"}})],1):(item.sorter)?_c('span',{staticClass:"c-table__sort"},[_c('div',{staticClass:"c-sort-asc",class:{'sorted': _vm.checkSorted(item.key, 'asc')},on:{"click":function($event){_vm.onSorted(item.key, 'asc');}}},[_c('i',{staticClass:"sort-asc"})]),_c('div',{staticClass:"c-sort-desc",class:{'sorted': _vm.checkSorted(item.key, 'desc')},on:{"click":function($event){_vm.onSorted(item.key, 'desc');}}},[_c('i',{staticClass:"sort-desc"})])]):_vm._e()])],2)}))})),_c('tbody',[(_vm.dataList.length == 0)?_c('tr',{staticClass:"c-table__noresult"},[_c('td',{attrs:{"colspan":_vm.columns.length}},[_vm._v("暂无数据")])]):_vm._l((_vm.dataList),function(dataItem,index){return _c('tr',{class:_vm.getRowClassName(_vm.item, index),on:{"mouseenter":function($event){_vm.setCurrentItem(dataItem);},"mouseleave":_vm.resetCurrentItem}},_vm._l((_vm.allColumns),function(columnsItem){return _c('td',{class:_vm.getColumnClassName(columnsItem),style:(_vm.getCellStyle(columnsItem))},[_vm._t(columnsItem.key + '-base-td',[(columnsItem.type === 'selection')?_c('span',{staticClass:"c-table__check"},[_c('c-checkbox',{on:{"change":_vm.onSelectChange},model:{value:(dataItem._checked),callback:function ($$v) {_vm.$set(dataItem, "_checked", $$v);},expression:"dataItem._checked"}})],1):_vm._e(),(columnsItem.render)?_c('div',{domProps:{"innerHTML":_vm._s(columnsItem.render(index, dataItem[columnsItem.key], dataItem))}}):_c('span',[_vm._v(_vm._s(dataItem[columnsItem.key]))])],{item:dataItem})],2)}))})],2)])]],2)},staticRenderFns: [],
  name: 'c-basetable',
  props: {
    columns: Array,
    datasource: Array,
  ...
  computed: {
    getTbodyStyle: function getTbodyStyle () {
      if (this.$el) {
        var tableStyle = this.$el.querySelector('table').getClientRects()[0];
        var theadWidth = tableStyle.width;
        var tbodyHeight = tableStyle.height;
        return {
  ...
  watch: {
    datasource: function datasource (newVal, oldVal) {
...
var Mod32 = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:_vm.className},[(_vm.hasFixed)?_c('div',{staticClass:"c-table"},[(_vm.fixedLeftColumns.length > 0)?_c('div',{staticClass:"c-fixtable__left",style:(_vm.getFixedTableStyle(_vm.fixedLeftColumns))},[_c('c-basetable',{attrs:{"columns":_vm.fixedLeftColumns,"datasource":_vm.datasource,"height":_vm.height,"sortkey":_vm.sortkey,"sortorder":_vm.sortorder,"rowClassName":_vm.rowClassName},on:{"sort":_vm.sorter,"selectChange":_vm.selectChange},scopedSlots:_vm._u([_vm._l((_vm.fixedLeftColumns),function(item){return {key:item.key + '-base-th',fn:function(props){return _vm.$scopedSlots[item.key+'-th']?[_vm._t(item.key + '-th',null,{item:props})]:undefined}}}),_vm._l((_vm.fixedLeftColumns),function(item){return {key:item.key + '-base-td',fn:function(props){return _vm.$scopedSlots[item.key+'-td']?[_vm._t(item.key + '-td',null,{item:props.item})]:undefined}}})])})],1):_vm._e(),_c('div',{staticClass:"c-scrolltable"},[_c('c-basetable',{attrs:{"columns":_vm.columns,"datasource":_vm.datasource,"height":_vm.height,"sortkey":_vm.sortkey,"sortorder":_vm.sortorder,"rowClassName":_vm.rowClassName},on:{"sort":_vm.sorter,"selectChange":_vm.selectChange},scopedSlots:_vm._u([_vm._l((_vm.columns),function(item){return {key:item.key + '-base-th',fn:function(props){return _vm.$scopedSlots[item.key+'-th']?[_vm._t(item.key + '-th',null,{item:props})]:undefined}}}),_vm._l((_vm.columns),function(item){return {key:item.key + '-base-td',fn:function(props){return _vm.$scopedSlots[item.key+'-td']?[_vm._t(item.key + '-td',null,{item:props.item})]:undefined}}})])})],1),(_vm.fixedRightColumns.length > 0)?_c('div',{staticClass:"c-fixtable__right",style:(_vm.getFixedTableStyle(_vm.fixedRightColumns))},[_c('c-basetable',{attrs:{"columns":_vm.fixedRightColumns,"datasource":_vm.datasource,"height":_vm.height,"sortkey":_vm.sortkey,"sortorder":_vm.sortorder,"rowClassName":_vm.rowClassName},on:{"sort":_vm.sorter,"selectChange":_vm.selectChange},scopedSlots:_vm._u([_vm._l((_vm.fixedRightColumns),function(item){return {key:item.key + '-base-th',fn:function(props){return _vm.$scopedSlots[item.key+'-th']?[_vm._t(item.key + '-th',null,{item:props})]:undefined}}}),_vm._l((_vm.fixedRightColumns),function(item){return {key:item.key + '-base-td',fn:function(props){return _vm.$scopedSlots[item.key+'-td']?[_vm._t(item.key + '-td',null,{item:props.item})]:undefined}}})])})],1):_vm._e()]):_c('div',{staticClass:"c-table"},[_c('c-basetable',{attrs:{"columns":_vm.columns,"datasource":_vm.datasource,"height":_vm.height,"sortkey":_vm.sortkey,"sortorder":_vm.sortorder,"rowClassName":_vm.rowClassName},on:{"sort":_vm.sorter,"selectChange":_vm.selectChange},scopedSlots:_vm._u([_vm._l((_vm.columns),function(item){return {key:item.key + '-base-th',fn:function(props){return _vm.$scopedSlots[item.key+'-th']?[_vm._t(item.key + '-th',null,{item:props})]:undefined}}}),_vm._l((_vm.columns),function(item){return {key:item.key + '-base-td',fn:function(props){return _vm.$scopedSlots[item.key+'-td']?[_vm._t(item.key + '-td',null,{item:props.item})]:undefined}}})])})],1)])},staticRenderFns: [],
  name: 'c-table',
  props: {
    columns: Array,
    datasource: Array,
  ...
  methods: {
    getFixedTableStyle: function getFixedTableStyle (colunms) {
      return {}
    },
