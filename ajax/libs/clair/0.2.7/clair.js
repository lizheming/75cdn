  ...
  methods: {
    validate: function validate () {
      ...
      if (!rules.msg.required) {
        var label = this.$formItem ? this.$formItem.label : '';
...
var TreeNode = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"c-tree__node"},[_c('div',{staticClass:"c-tree__title",class:{ 'is-leaf': !_vm.hasChildren },on:{"click":_vm.onNodeClick}},[(_vm.hasChildren)?_c('c-icon',{attrs:{"valign":"middle","name":_vm.iconName}}):_vm._e(),(_vm.$tree.checkable)?_c('c-checkbox',{attrs:{"indeterminate":_vm.indeterminate},on:{"change":_vm.checkChange},model:{value:(_vm.node.checked),callback:function ($$v) {_vm.$set(_vm.node, "checked", $$v);},expression:"node.checked"}}):_vm._e(),_c('div',{staticClass:"c-tree__label"},[_c('c-node-label',{attrs:{"node":_vm.node}})],1)],1),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.showChildren),expression:"showChildren"}],staticClass:"c-tree_children"},_vm._l((_vm.node.children),function(child){return _c('c-tree-node',{ref:"children",refInFor:true,attrs:{"node":child,"default-expanded-keys":_vm.defaultExpandedKeys,"level":_vm.level + 1}})}))])},staticRenderFns: [],
  ...
  watch: {
    defaultExpandedKeys: {
      immediate: true,
      handler: function handler (expandedKeys) {
        if (!expandedKeys || expandedKeys.length === 0) { return }
        var id = this.node[this.$tree.nodeKey];
        var isExpanded = expandedKeys.indexOf(id) > -1;
...
var Mod36 = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"c-tree"},_vm._l((_vm.nodes),function(node){return _c('c-tree-node',{attrs:{"node":node,"level":1,"default-expanded-keys":_vm.defaultExpandedKeys}})}))},staticRenderFns: [],
  name: 'c-tree',
  props: {
  ...
  methods: {
    ...
    filterNodes: function filterNodes (filter) {
      ...
      var filtered = allNodes.map(getNode).filter(filter);
      return filtered
    },
