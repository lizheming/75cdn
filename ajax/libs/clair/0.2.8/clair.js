...
var Menu = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('ul',{staticClass:"cascader-menu"},_vm._l((_vm.optionList),function(item){return _c('li',{staticClass:"casecader-menu-item",class:{'active': item.selected},attrs:{"title":item[_vm.showkey]},on:{"click":function($event){_vm.onMenuClick(item);}}},[_vm._v(_vm._s(item[_vm.labelKey])),(_vm.hasChildren(item))?_c('span',{staticClass:"cascader-icon"},[_c('c-icon',{attrs:{"name":"chevron-right"}})],1):_vm._e()])})),_c('div',{staticClass:"c-cascader__childmenu"},[(_vm.childrenOptions.length > 0)?_c('c-cascader-menu',{attrs:{"parentMenu":_vm.currentParentMenu,"options":_vm.childrenOptions,"labelKey":_vm.labelKey,"valueKey":_vm.valueKey,"level":_vm.level + 1}}):_vm._e()],1)])},staticRenderFns: [],_scopeId: 'data-v-125e08b0',
  ...
  created: function created () {
    ...
    if (this.$cascader.value.length) {
      var selectedItem = this.optionList.find(function (option) { return option[this$1.valueKey] === this$1.$cascader.value[this$1.level]; });
  ...
  methods: {
    resetOptionSelected: function resetOptionSelected () {
      ...
      this.optionList = [].concat( this.options ).map(function (item) {
...
var Mod10 = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"c-cascader",on:{"click":function($event){_vm.isOpen = true;}}},[_c('div',{staticClass:"cascader-context"},[_c('c-input',{attrs:{"placeholder":_vm.placeholder,"width":"normal","disabled":_vm.disabled},model:{value:(_vm.showValue),callback:function ($$v) {_vm.showValue=$$v;},expression:"showValue"}}),_c('c-icon',{staticClass:"c-cascader__icon",attrs:{"name":"chevron-down"}})],1),_c('div',{staticClass:"cascader-dropmenu"},[(_vm.isOpen)?[_c('Menu',{attrs:{"parentMenu":_vm.parentMenu,"options":_vm.optionList,"labelKey":_vm.labelKey,"valueKey":_vm.valueKey}})]:_vm._e()],2)])},staticRenderFns: [],
  name: 'c-cascader',
  components: {
    Menu: Menu
  },
  ...
  methods: {
    ...
    getLabelWithValue: function getLabelWithValue (value) {
      ...
      value.reduce(function (result, item) {
        var ref = result.find(function (data) { return data[this$1.valueKey] === item; });
...
var Mod38 = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"c-tree"},_vm._l((_vm.nodes),function(node){return _c('c-tree-node',{attrs:{"node":node,"level":1,"default-expanded-keys":_vm.defaultExpandedKeys}})}))},staticRenderFns: [],
  name: 'c-tree',
  props: {
