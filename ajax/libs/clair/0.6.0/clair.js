...
(function (global, factory) {
  ...
  */
  ...
  var index$a = shouldUseNative() ? Object.assign : function (target, source) {
  ...
  var VColorComponent = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"cp__wrapper"},[_c('v-ctrl',{attrs:{"direction":"vh","precision":2,"throttle":80},on:{"change":_vm.onSaturationChange}},[_c('div',{staticClass:"cp__v-ctrl cp__saturation"},[_c('div',{staticClass:"msk-hue",style:(_vm.styles.saturationPane)}),_vm._v(" "),_c('div',{staticClass:"msk-white"}),_vm._v(" "),_c('div',{staticClass:"msk-black"}),_vm._v(" "),_c('p',{staticClass:"cp__thumb",style:(_vm.styles.saturationThumb)})])]),_vm._v(" "),_c('div',{staticClass:"cp__ctrl-pane"},[_c('div',[_c('div',{staticClass:"cp__preview"},[_c('div',{style:(_vm.styles.preview)})]),_vm._v(" "),_c('div',{staticClass:"cp__tracks"},[_c('v-ctrl',{attrs:{"direction":"h","precision":2,"throttle":80},on:{"change":_vm.onHueChange}},[_c('div',{staticClass:"cp__v-ctrl cp__ctrl-bar cp__ctrl-hue"},[_c('div',{staticClass:"cp__thumb",style:(_vm.styles.hueThumb)})])]),_vm._v(" "),_c('v-ctrl',{attrs:{"direction":"h","precision":2,"throttle":80},on:{"change":_vm.onAlphaChange}},[_c('div',{staticClass:"cp__v-ctrl cp__ctrl-alpha"},[_c('div',{staticClass:"cp__thumb",style:(_vm.styles.alphaThumb)}),_vm._v(" "),_c('div',{staticClass:"cp__ctrl-bar",style:(_vm.styles.alphaTrack)})])])],1)]),_vm._v(" "),_c('div',{staticStyle:{"margin-top":"10px"}},[_c('div',{staticClass:"cp__fm-fields"},_vm._l((_vm.colorModes[_vm.currentMode]),function(k){return _c('div',{key:k},[_c('div',{staticStyle:{"position":"relative"}},[_c('input',{attrs:{"type":_vm.constrains[k].type,"maxlength":_vm.constrains[k].maxlength},domProps:{"value":_vm.colorModel[k]},on:{"change":function($event){_vm.handleInput(k, $event);}}}),_vm._v(" "),_c('span',[_vm._v(_vm._s(k))])])])})),_vm._v(" "),_c('div',{staticClass:"cp__fm-switcher"},[_c('div',{on:{"click":function($event){_vm.changecurrentMode();}}},[_c('svg',{attrs:{"viewBox":"0 0 24 24"}},[_c('path',{attrs:{"fill":"#333","d":"M12,5.83L15.17,9L16.58,7.59L12,3L7.41,7.59L8.83,9L12,5.83Z"}}),_vm._v(" "),_c('path',{attrs:{"fill":"#333","d":"M12,18.17L8.83,15L7.42,16.41L12,21L16.59,16.41L15.17,15Z"}})])])])])])],1)},staticRenderFns: [],
    ...
    watch: {
      color: {
        ...
        handler: function handler (newVal, oldVal) {
          if (newVal !== oldVal) {
            index$a(this, this.digestProp(newVal));
          }
        }
      },
      rgba: {
    ...
    methods: {
      ...
      emitChange: function emitChange () {
        ...
        var g = rgba[1];
        var b = rgba[2];
        var shortHex = index$a(this.colorModel, {
      ...
      handleInput: function handleInput (type, event) {
        ...
        if (changed) {
          ...
          index$a(this, this.digestProp(literal));
        }
      }
    },
  ...
  var $0_16 = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"c-datepicker",on:{"click":_vm.open}},[(!_vm.disabled && _vm.date != '' || _vm.daterange != '')?_c('div',{staticClass:"c-datepicker__icon c-datepicker__hovericon",class:_vm.className,on:{"click":_vm.resetDate}},[_c('c-icon',{attrs:{"name":"x-circle"}})],1):_vm._e(),_c('div',{staticClass:"c-datepicker__icon",attrs:{"clas":_vm.className}},[_c('c-icon',{attrs:{"name":"calendar"}})],1),(_vm.type == 'daterange' || _vm.type == 'monthrange')?_c('c-input',{attrs:{"value":_vm.daterange,"placeholder":_vm.placeholder,"disabled":_vm.disabled,"width":"normal","size":_vm.size},nativeOn:{"focusin":function($event){return _vm.open($event)},"focusout":function($event){return _vm.onBlur($event)}}}):(_vm.type == 'date' || _vm.type == 'month')?_c('c-input',{attrs:{"size":_vm.size,"width":"normal","placeholder":_vm.placeholder,"disabled":_vm.disabled},on:{"change":_vm.dateChange},nativeOn:{"focusin":function($event){return _vm.open($event)},"focusout":function($event){return _vm.onBlur($event)},"keydown":function($event){return _vm.onKeyDown($event)}},model:{value:(_vm.date),callback:function ($$v) {_vm.date=$$v;},expression:"date"}}):_vm._e(),_c('div',{ref:"datepickerPanel",staticClass:"c-datepicker__panel",class:{'withSidebar': (_vm.optionList.length > 0 || _vm.hasSidebarSlot) && _vm.isOpen == true, 'withBorder': _vm.isOpen == true }},[((_vm.hasSidebarSlot || _vm.optionList.length > 0 )&& _vm.isOpen)?_c('div',{staticClass:"c-datepicker__sidebar"},[_vm._t("dateSideBar",[_c('ul',[_vm._l((_vm.optionList),function(option){return [_c('li',{staticClass:"optionbtn",on:{"click":function($event){_vm.optionClick(option);}}},[_c('a',[_vm._v(_vm._s(option.text))])])]})],2)],{datepicker:_vm.datepicker})],2):_vm._e(),(_vm.type == 'date' || _vm.type == 'month')?_c('c-calendar',{ref:"calendar",attrs:{"type":_vm.type,"pattern":_vm.datePattern,"value":_vm.date,"show":_vm.isOpen,"size":_vm.size,"minDate":_vm.minDate,"maxDate":_vm.maxDate},on:{"update":_vm.setDate}}):_vm._e(),(_vm.type == 'daterange')?_c('div',{staticClass:"c-datepicker__body"},[_c('c-daterange',{attrs:{"value":_vm.date,"size":_vm.size,"show":_vm.isOpen},on:{"change":_vm.setDateRange}})],1):_vm._e(),(_vm.type == 'monthrange')?_c('div',{staticClass:"c-datepicker__body"},[_c('c-daterange',{attrs:{"value":_vm.date,"size":_vm.size,"show":_vm.isOpen,"type":"month"},on:{"change":_vm.setDateRange}})],1):_vm._e()],1)],1)},staticRenderFns: [],
    ...
    methods: {
      ...
      getStyle: function getStyle () {
        ...
        var droplistWidth = this.datepickerPanel.clientWidth;
        var defaultTop = clientRect.top + clientRect.height + marginTop + window.pageYOffset;
        var clientHeight = clientRect.height + marginTop;

        var clientY = clientRect.y;
        var compTop = windowH - droplistHeight - scrollHeight;
        var marginRight = 15; // scrollbar width
        var left = droplistWidth + clientRect.left + window.pageXOffset > windowW ? windowW - droplistWidth - marginRight : clientRect.left + window.pageXOffset;
  ...
  var $0_43 = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"c-toolbar",class:{'is-primary': _vm.primary},style:(_vm.style)},[_vm._t("default")],2)},staticRenderFns: [],
    props: {
      height: String,
      background: String,
      color: String,
  ...
  var $0_44 = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"c-toolbar__item",class:{'is-flex': _vm.flex}},[_vm._t("default")],2)},staticRenderFns: [],
    props: {
      flex: Boolean
    },
    name: 'c-toolbar-item'
  ...
  var $0_45 = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"c-tree"},_vm._l((_vm.nodes),function(node,index){return _c('c-tree-node',{key:index,attrs:{"node":node,"level":1}})}))},staticRenderFns: [],
    name: 'c-tree',
    props: {
  ...
  './tip/index.vue': CTip,
  './toolbar/index.vue': $0_43,
  './toolbar/toolbar-item.vue': $0_44,
  './tree/index.vue': $0_45,
  './tree/tree-node.vue': TreeNode,
  './upload/index.vue': $0_47,
